...
class RecipeList : Fragment() {
    ...
    private lateinit var listAdapter: RecipeListRecycleAdapter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        listAdapter= RecipeListRecycleAdapter(foodNameList,foodIdList)
    ...
    fun fetchData(){
        try {
            ...
            println("VERİTABANINDA Hata Oluştu ${e.toString()}")
        }
    }
